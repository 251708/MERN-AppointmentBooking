    ...
    <div>
      ...
      <div>
        {appointments.map((item,index) => (
         ...
         {!item.cancelled && <button /* onClick = {() => appointmentRazorpay} */className='text-sm text-stone-500 text-center sm:min-w-48 py-2 border hover:bg-primary hover:text-white transition-all duration-300'>Pay Online</button> } 
